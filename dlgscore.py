...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Evaluate The Performance Of Your Fantasy Team"))
        self.label_2.setText(_translate("Dialog", "Choose Team"))
        self.label.setText(_translate("Dialog", "Choose Match"))
        self.cb0.setItemText(0, _translate("Dialog", "Choose Team"))
        self.cb1.setItemText(0, _translate("Dialog", "Choose Match"))
